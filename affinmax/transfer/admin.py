...
class TransferGroupListAdmin(admin.ModelAdmin):
    list_display = ("related_tran_id", "total_tran_amount", "success_tran_amount", "current_balance", "created_at", "updated_at")
    search_fields = ("related_tran_id",)

# TransferList 后台
@admin.register(TransferList)
class TransferListAdmin(admin.ModelAdmin):
    list_display = ("tran_id", "amount", "bene_acc_no", "bene_name", "bank_code", "recRef", "phone_number", "group_id", "complete_date", "updated_at", "error_message")
